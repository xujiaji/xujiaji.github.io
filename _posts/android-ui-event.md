...
![Android UI事件传递.png](blog/android-ui-event/ui-event.png)
...
![1](blog/android-ui-event/1.png)

上图简略关系如下：
![布局简略关系.png](blog/android-ui-event/2.png)
...
![没有拦截事件时.png](blog/android-ui-event/3.png)
...
![拦截ViewGroup1的所有事件.png](blog/android-ui-event/4.png)
...
![当ViewGroup2事件获取到了，但没有消费.png](blog/android-ui-event/5.png)
...
![当消费ViewGroup2的按下DOWN事件时.png](blog/android-ui-event/6.png)

> 当ViewGroup2中onTouchEvent直接返回true时

![当ViewGroup2中onTouchEvent直接返回true时.png](blog/android-ui-event/7.png)
## Button获取事件是怎么回事？
...
![Button获取触摸事件.png](blog/android-ui-event/8.png)
...
![效果图](blog/android-ui-event/9.png)
