...
![Android UI事件传递](blog/android-ui-event/ui-event.png)
...
上图简略关系如下：
![布局简略关系](blog/android-ui-event/2.png)
...
![没有拦截事件时](blog/android-ui-event/3.png)
...
![拦截ViewGroup1的所有事件](blog/android-ui-event/4.png)
...
![当ViewGroup2事件获取到了，但没有消费](blog/android-ui-event/5.png)
...
![当消费ViewGroup2的按下DOWN事件时](blog/android-ui-event/6.png)

> 当ViewGroup2中onTouchEvent直接返回true时

![当ViewGroup2中onTouchEvent直接返回true时](blog/android-ui-event/7.png)
## Button获取事件是怎么回事？
...
![Button获取触摸事件](blog/android-ui-event/8.png)
