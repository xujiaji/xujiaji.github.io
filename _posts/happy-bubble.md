...
![1.1.3.gif](image/happy-bubble/1.1.3.gif)
...
|||
|-|-|
|![exampel1](image/happy-bubble/img_example1.png)|![exampel2](image/happy-bubble/img_example2.png)|
...
```
### 向下偏移8dp
![exampel3](image/happy-bubble/img_example3.png)
``` java
new BubbleDialog(this)
        .addContentView(LayoutInflater.from(this).inflate(R.layout.dialog_view3, null))
...
```
### 当想要输入框随软键盘上移时
![exampel4](image/happy-bubble/gif_example4.gif)
``` java
new BubbleDialog(this)
...
```
### 自定义 BubbleLayout.
![exampel5](image/happy-bubble/img_example5.png)
...
![exampel6](image/happy-bubble/gif_example6.gif)
> 1、布局
...
![GIF](image/happy-bubble/gif1.gif)
