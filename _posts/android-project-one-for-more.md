...
![图片](blog/one-for-more/20181029171053.png)
...
4. 可在build.gradle中配置动态配置java代码调用的常量数据（如：通过该方式我们可根据不同渠道动态配置第三方appid，或其他需要根据渠道而改变的数据）
 ...
 ![图片](blog/one-for-more/20181030234102.png)
...
![图片](blog/one-for-more/20181029233306.png)
...
![图片](blog/one-for-more/20181029234235.png)
